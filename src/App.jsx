...
function App() {
  ...
  {/* 🔑 Backdrop + Mobile Slide-out Menu */}
  {isMobileMenuOpen && (
    <>
      {/* Backdrop */}
      <div
      ...
      {/* Sidebar */}
      <div
        className={`fixed inset-y-0 right-0 w-64 bg-white/65 shadow-lg transform transition-transform duration-300 ease-in-out z-50 ${
